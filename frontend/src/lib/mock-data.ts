...
window.MOCK_STATE = {
  ...
  memory: {
    ...
    pinned: ['黑铁怀表停在三时四十二分，与残页时间吻合', '沈知微说过『若残页足三，则可推时』'],
    facts: ['光绪十三年雾港曾沉船一艘，载客 142 人', '灯塔守人姓童，与南陵童氏同源'],
    notes: ['玩家笔记：阿衡可能不是守人亲女'],
    last_retrieval:
...
window.MOCK_RUN_STEPS = [
  {
    ...
    message: '正在召回上下文 · 检索原文与历史',
    status: 'done',
    elapsed_ms: 820,
    detail: '返回 6 个章节片段，含第 312–315 章。',
  },
  {
    phase: 'context_agent',
    message: '子代理筛选上下文 · 仅保留与『揭示身份』相关',
    status: 'done',
    elapsed_ms: 1240,
    detail: '丢弃 11 段，保留 4 段；预算 4180 tokens。',
  },
  {
    phase: 'world_check',
    message: '校验世界线约束 · 残页引用次数',
    status: 'done',
    elapsed_ms: 180,
    detail: '残页可用次数：剩余 1 次。',
  },
  {
    phase: 'prompt_assemble',
    message: '组装提示词 · 注入状态、记忆、固定记忆',
    status: 'done',
    elapsed_ms: 90,
  },
  ...
  scripts: [
    {
      ...
      uid: 'scr_7c1a',
      title: '雾港未尽',
      description: '示例剧本 · 已识别 1208 章',
      chapter_count: 1208,
      word_count: 2_413_000,
      import_report: {
        mode_label: '标准章节标题',
        confidence: 0.92,
        problem_label: '未发现明显异常',
      },
      updated_at: '2 小时前',
    },
    {
      ...
      uid: 'scr_3e44',
      title: '南陵旧灯录',
      description: '导入剧本 · 612 章',
      chapter_count: 612,
      word_count: 1_204_000,
      import_report: {
        mode_label: '中文章节规则',
        confidence: 0.86,
        problem_label: '卷标题不规则',
        reasons: ['跨卷尾章缺失'],
      },
      updated_at: '昨天',
    },
    {
      ...
      uid: 'scr_b811',
      title: '海上落星',
      description: '导入剧本 · 短篇集 88 篇',
      chapter_count: 88,
      word_count: 220_000,
      import_report: {
        mode_label: '数字点号规则',
        confidence: 0.74,
        problem_label: '存在 3 段疑似引言',
        reasons: ['第 12、43、77 段长度异常'],
      },
      updated_at: '3 天前',
    },
    {
