...
let h2;
try {
  h2 = ReactDOMServer.renderToString(
    React.createElement(global.PanelContext, { state: filledState }),
  );
} catch (e) {
...
if (h2.includes('[object Object]'))
  fail('PanelContext chapter_refs 含对象不应渲染成 [object Object]');
